...
def compare_antithetic_area(n_simulations, n_samples, iterations, bounds,
    ...
    for func_idx, samping_func in enumerate(funcs):
        for i in range(n_simulations):
            ...
            area_1 = a.calculate_area(samping_func, bounds, s=n_samples, i=iterations, seed1=n_simulations,
                                      seed2=n_simulations + 1, arr_samples=arr_samples, antithetic=False)
            # run simulation inverted
            arr_samples_anti = sa.convert_antithetic(arr_samples)
            area_2 = a.calculate_area(samping_func, bounds, s=n_samples, i=iterations, seed1=n_simulations * 2,
                                      seed2=n_simulations * 2 + 1, arr_samples=arr_samples_anti, antithetic=True)
            # take average area
